...
U = [50]
#U = [10, 20, 25, 30, 35, 40, 50, 60, 70, 80, 90, 100]
...
#q = [0.2*10**6, 0.25*10**6, 0.3*10**6, 0.4*10**6, 0.5*10**6, 0.7*10**6, 0.9*10**6, 1.2*10**6, 1.5*10**6, 2.0*10**6, 2.5*10**6, 3.0*10**6, 4.0*10**6, 5.0*10**6, 6.0*10**6, 8.0*10**6]

q = [8334, 10417, 12500, 16667, 20834, 29167, 37500, 50000, 62500, 83334, 104167, 125000, 166667, 208334, 250000, 333334]