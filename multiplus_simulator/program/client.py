...
def get_longitude(dataset, U, t, sim):
    random.seed((1+sim)*1000+(1+U))
...
def weighted_tiles(dataset, U, t, sim):
    ...
    teta_o = get_longitude(dataset, U, t, sim)
...
def request_RA(requests, t, t_dur_stalls, throughput, dataset, U, buffer, sim):
    delta_budget = 0
    ...
    tiles = weighted_tiles(dataset, U, t-t_dur_stalls, sim)
